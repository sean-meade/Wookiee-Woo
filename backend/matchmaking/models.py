...
class FilmResults(models.Model):
    ...
    the_empire_strikes_back = models.IntegerField(validators=[MinValueValidator(1), MaxValueValidator(10)],blank=True)
    return_of_the_jedi = models.IntegerField(validators=[MinValueValidator(1), MaxValueValidator(10)],blank=True)
    the_phantom_menace = models.IntegerField(validators=[MinValueValidator(1), MaxValueValidator(10)],blank=True)
    ...
    the_force_awakens = models.IntegerField(validators=[MinValueValidator(1), MaxValueValidator(10)],blank=True)
    the_last_jedi = models.IntegerField(validators=[MinValueValidator(1), MaxValueValidator(10)],blank=True)
    the_rise_of_skywalker = models.IntegerField(validators=[MinValueValidator(1), MaxValueValidator(10)],blank=True)
    ...
    the_mandalorian = models.IntegerField(validators=[MinValueValidator(1), MaxValueValidator(10)],blank=True)
    the_book_of_boba_fett = models.IntegerField(validators=[MinValueValidator(1), MaxValueValidator(10)],blank=True)
    ...
    the_clone_wars = models.IntegerField(validators=[MinValueValidator(1), MaxValueValidator(10)],blank=True)
    ...
    the_bad_batch = models.IntegerField(validators=[MinValueValidator(1), MaxValueValidator(10)],blank=True)
